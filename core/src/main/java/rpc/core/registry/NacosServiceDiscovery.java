...
import rpc.core.loadbalancer.LoadBalancer;
import rpc.core.loadbalancer.RandomLoadBalancer;
...
public class NacosServiceDiscovery implements ServiceDiscovery{
    ...
    private static Logger logger= LoggerFactory.getLogger(NacosServiceDiscovery.class);
    ...
    public InetSocketAddress lookupService(String serviceName) {
        try{
            ...
            Instance instance=loadBalancer.select(list);
